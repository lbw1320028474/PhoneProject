...
public class UserLoginResponse extends BaseResponse{
	...
	public String toString() {
		return "UserLoginResponse [userAccount=" + userAccount + ", fyAccount="
				+ fyAccount + ", fyPassword=" + fyPassword + ", userState="
				+ userState + ", creatDate=" + creatDate + ", userName="
				+ userName + ", userNikeName=" + userNikeName + ", userNumber="
				+ userNumber + ", userVipState=" + userVipState
				+ ", maxPhoneTime=" + maxPhoneTime + ", loginState="
