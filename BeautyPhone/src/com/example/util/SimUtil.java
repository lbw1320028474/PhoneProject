...
public class SimUtil {
	...
	// 获取双卡双待SIM卡的服务商
	public String getOperatorBySlot(int slotID) {
	...
	public static class SimInfomation{
		...
		public String toString() {
			return "SimInfomation [number=" + number + ", simId=" + simId + ", simIndex=" + simIndex + "]";
		}
	}
